...
def SNV_naive_signature(df_sig_count):
	...
	#need to change height to a proportion of graph
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#3498db", edgecolor=None, clip_on=False)
	ax[0].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#2ecc71", edgecolor=None, clip_on=False)
	ax[1].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#e74c3c", edgecolor=None, clip_on=False)
	ax[2].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#95a5a6", edgecolor=None, clip_on=False)
	ax[3].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#FFAE42", edgecolor=None, clip_on=False)
	ax[4].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=16, height=0.035, fill=True, facecolor="#9b59b6", edgecolor=None, clip_on=False)
	ax[5].add_patch(rect)

	# ax[0].annotate("C>A", xy=(0.5,0.9), xycoords='figure fraction', fontsize=6)
	ax[0].annotate("C>A", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
	ax[1].annotate("C>G", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
	ax[2].annotate("C>T", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
	ax[3].annotate("T>A", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
	ax[4].annotate("T>C", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
	ax[5].annotate("T>G", (7.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="center", annotation_clip=False)
...
#%% ==========================================================	
# plot average naive indel profile
# ============================================================
...
def INDEL_naive_signature(df_sig_count):
	...
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#fdae6b", edgecolor=None, clip_on=False)
	ax[0].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#e6550d", edgecolor=None, clip_on=False)
	ax[1].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#a1d99b", edgecolor=None, clip_on=False)
	ax[2].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#31a354", edgecolor=None, clip_on=False)
	ax[3].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#fee5d9", edgecolor=None, clip_on=False)
	ax[4].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#fcae91", edgecolor=None, clip_on=False)
	ax[5].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#fb6a4a", edgecolor=None, clip_on=False)
	ax[6].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#cb181d", edgecolor=None, clip_on=False)
	ax[7].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#bdd7e7", edgecolor=None, clip_on=False)
	ax[8].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#6baed6", edgecolor=None, clip_on=False)
	ax[9].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#3182bd", edgecolor=None, clip_on=False)
	ax[10].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=6, height=ht, fill=True, facecolor="#08519c", edgecolor=None, clip_on=False)
	ax[11].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=1, height=ht, fill=True, facecolor="#cbc9e2", edgecolor=None, clip_on=False)
	ax[12].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=2, height=ht, fill=True, facecolor="#9e9ac8", edgecolor=None, clip_on=False)
	ax[13].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=3, height=ht, fill=True, facecolor="#6a51a3", edgecolor=None, clip_on=False)
	ax[14].add_patch(rect)
	rect = Rectangle((-0.5,top_of_graph), width=5, height=ht, fill=True, facecolor="#54278f", edgecolor=None, clip_on=False)
	ax[15].add_patch(rect)

	ax[0].annotate("C", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[1].annotate("T", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[2].annotate("C", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[3].annotate("T", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[4].annotate("2", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[5].annotate("3", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[6].annotate("4", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[7].annotate("5+", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[8].annotate("2", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[9].annotate("3", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[10].annotate("4", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[11].annotate("5+", (2,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[12].annotate("2", (-0.35,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[13].annotate("3", (0,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[14].annotate("4", (0.5,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	ax[15].annotate("5+", (1,top_of_graph+0.005), fontsize=5, va="bottom", ha="left", annotation_clip=False)
	...
	plt.subplots_adjust(wspace=0.01, left=0.055, right=0.998, bottom=0.17, top=0.9)
	return fig, ax


#%% ==========================================================
# plot average naive copy number profile
# ============================================================
...
SNV_naive_signature(df)
plt.savefig(os.path.join(figdir, "snv96_all_samples.png"), dpi=500)
plt.savefig(os.path.join(figdir, "snv96_all_samples.pdf"))
# plt.close()
INDEL_naive_signature(df)
plt.savefig(os.path.join(figdir, "indel83_all_samples.png"), dpi=500)
plt.savefig(os.path.join(figdir, "indel83_all_samples.pdf"))
# plt.close()
CN_naive_signature(df)
plt.savefig(os.path.join(figdir, "segs45_all_samples.png"), dpi=500)
plt.savefig(os.path.join(figdir, "segs45_all_samples.pdf"))
# plt.close()
